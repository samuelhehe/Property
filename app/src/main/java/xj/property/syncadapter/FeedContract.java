...
public class FeedContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "xj.property.android.network.sync.basicsyncadapter";

    /**
     * Base URI. (content://xj.property.android.network.sync.basicsyncadapter)
     */
