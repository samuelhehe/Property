...
public class NotifyNotification {
     ...
     * @param id    通知的唯一标示ID
     */
    public NotifyNotification(Context context, PendingIntent contentIntent, int id) {
     ...
     */
    public void showCustomizeNotification(int icoId,String titleStr,int layoutId,String contentStr) {
...
//            remoteView.setProgressBar(R.id.pbNotification, 100, 0, false);
        ...
        Log.i("onion","通知"+notification.contentIntent);
