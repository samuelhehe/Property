...
import xj.property.beans.LatitudeAndLongitude;
import xj.property.beans.MyMessage;
import xj.property.beans.PostObjEvent;
import xj.property.beans.SCell;
import xj.property.ums.common.AssembJSONObj;
import xj.property.ums.common.CommonUtil;
import xj.property.ums.common.MD5Utility;
import xj.property.ums.common.MyCrashHandler;
import xj.property.ums.common.NetworkUitlity;
import xj.property.ums.common.UmsConstants;
import xj.property.ums.controller.EventController;
import xj.property.ums.controller.TagController;
import xj.property.ums.dao.GetInfoFromFile;
import xj.property.ums.dao.SaveInfo;
...
//                    updateObject.toString());
            Log.i("onion","网络畅通");
            MyMessage message = NetworkUitlity.post(UmsConstants.updataUrl,
                    updateObject.toString());

            Log.i("onion","message.isFlag"+message.isFlag());
            if (message.isFlag()) {
                try {
