...
public class WheelView extends View {
    ...
    /** 当前条目中的文字颜色 0xF0FF6603*/
    private static final int VALUE_TEXT_COLOR = 0xFFFB7B2E;
...
//    private static final int[] SHADOWS_COLORS = new int[] { 0x00F1F1F1, 0xf0ffffff, 0xa8ffffff };
    private static final int[] SHADOWS_COLORS = new int[] { 0x00F1F1F1, 0x00ffffff, 0x00ffffff };
     ...
     * 0 顶部 和 底部的字正好紧贴 边缘,
     * 负数时 顶部和底部 与 字有一定间距 */
    private static int ITEM_OFFSET = -100;
    ...
    private void initData(Context context) {
        ...
        itemHeight = context.getResources().getDimensionPixelSize(R.dimen.wheel_time_item_height);
        ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelSize(R.dimen.wheel_time_additional_item_height);
        ITEM_OFFSET = context.getResources().getDimensionPixelSize(R.dimen.wheel_top_botm_padding);
    }
    ...
    private void initResourcesIfNecessary() {
        ...
        if (itemsPaint == null) {
           ...
           // itemsPaint.setTextSize(TEXT_SIZE);
            itemsPaint.setTextSize( getContext().getResources().getDimension(R.dimen.wheel_no_item_txt_color));
        }
        ...
        if (valuePaint == null) {
          ...
          //  valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.FAKE_BOLD_TEXT_FLAG );
           // valuePaint.setTextSize(TEXT_SIZE); wheel_text_size
            valuePaint.setTextSize( getContext().getResources().getDimension(R.dimen.wheel_text_size));
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        }

        //选中的条目背景
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_item_background_shape);
        }
         ...
         * 设置 View 组件的背景
         */
        setBackgroundResource(R.drawable.select_room_bag);
    }
    ...
    private void drawShadows(Canvas canvas) {
       // topShadow.setBounds(0, 0, getWidth(), getHeight() / visibleItems);
        ...
        topShadow.setBounds(0, 0, getWidth(),  (getHeight()-visibleItems*10)/2);
        topShadow.draw(canvas);

       // bottomShadow.setBounds(0, 0, getWidth(), getHeight()/2);

        bottomShadow.setBounds(0, getHeight() - ( (getHeight()-visibleItems*10)/2), getWidth(), getHeight());
