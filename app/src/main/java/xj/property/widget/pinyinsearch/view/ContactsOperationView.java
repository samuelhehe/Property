...
import xj.property.widget.pinyinsearch.adapter.ContactsAdapter;
...
//        ViewUtil.showView(mContactsIndexView);
    ...
    public void onInviteNeighbors(Contacts contacts) {
        ...
        if(null!=contacts){
            mOnContactsOperationView.onInviteNeighbors(contacts);
        }
...
//        ViewUtil.hideView(mContactsIndexView);
    ...
    private void initView() {
        ...
        mContactsOperationView = inflater.inflate(R.layout.common_contacts_operation,
                this);
...
//        ViewUtil.hideView(mContactsIndexView);
    ...
    private void initData() {
        mContactsAdapter = new ContactsAdapter(mContext,
                R.layout.common_contacts_list_item, ContactsHelper.getInstance()
                .getSearchContacts());
