package xj.property.widget.pinyinsearch.view;
...
import xj.property.widget.pinyinsearch.adapter.ContactsIndexAdapter;
import xj.property.widget.pinyinsearch.helper.ContactsIndexHelper;
import xj.property.widget.pinyinsearch.model.Contacts;
import xj.property.widget.pinyinsearch.model.ContactsIndex;
...
public class ContactsIndexView extends LinearLayout implements ContactsIndexAdapter.OnContactsIndexAdapter {
	...
	private void initView() {
		...
		mContactsIndexView = inflater.inflate(R.layout.common_contacts_index_view,
				this);
	...
	private void initData() {
		...
		mContactsIndexAdapter = new ContactsIndexAdapter(mContext,
				R.layout.common_contacts_index_list_item, mContactsIndex.getContacts());
