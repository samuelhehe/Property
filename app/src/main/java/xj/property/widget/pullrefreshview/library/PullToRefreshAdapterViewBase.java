...
import xj.property.widget.pullrefreshview.library.internal.EmptyViewMethodAccessor;
import xj.property.widget.pullrefreshview.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			// If we can't pull down, but have a View then remove itpull_refresh_strings.xml
