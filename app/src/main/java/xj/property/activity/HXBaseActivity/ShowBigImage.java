...
import xj.property.activity.user.MulitPointTouchListener;
import xj.property.task.LoadLocalBigImgTask;
import xj.property.utils.ImageCache;
import xj.property.widget.photoview.PhotoView;
...
public class ShowBigImage extends HXBaseActivity {
    ...
    private MulitPointTouchListener mptl;
