 ...
 *
 */
public class ActivityInviteNeighbors extends HXBaseActivity {
...
//        service.inviateByPhoneNum(StrUtils.string2md5(Config.BANGBANG_TAG + StrUtils.dataHeader(request)), request,  bean.getEmobId(), callback);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(ActivityInviteNeighbors.this, R.layout.common_bangzhu_invited_neighboritem, null);
...
//        String appId = "1104879006";
//        String appKey = "xdBs1p4srrKGMr4u";

        // 添加QQ支持, 并且设置QQ分享内容的target url
        UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler((Activity) mContext, Config.QQAPPID, Config.QQKEY);
        qqSsoHandler.setTargetUrl("http://www.linjubangbang.com");
        qqSsoHandler.addToSocialSDK();
        // 添加QZone平台
        QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler((Activity) mContext,Config.QQAPPID,Config.QQKEY);
        qZoneSsoHandler.addToSocialSDK();
    }
...
//		String appSecret = "426686f8eaacac48009903535c8b8969";
        String appId = "wx6333375cc8afdae7";
        String appSecret = "32af9fbceb1416f7ed0ec5a64979ea08";
        // 添加微信平台
