...
import xj.property.adapter.EmergencyNumberAdapter;
 ...
 */
public class EmergencyNumberActivity extends HXBaseActivity implements PullToRefreshLayout.OnRefreshListener {
    private int pageIndex = 1;
    private EmergencyNumberAdapter adapter;
    ...
    ArrayList<SendWaterListBean.DataEntity> waterSattions = new ArrayList<SendWaterListBean.DataEntity>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTitle(null, "便捷号码", "");
        initData();
//        addFragmentsInActivity(R.id.fl_error,new Fragment());
    }
        ...
        if (!CommonUtils.isNetWorkConnected(this)) {
            ...
            tv_getagain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!CommonUtils.isNetWorkConnected(EmergencyNumberActivity.this)) {
                        return;
                    } else {
    ...
    private void initView() {
        ...
        adapter = new EmergencyNumberAdapter(this, waterSattions);
...
//        void getCallList(@Path("communityId") long communityId, @QueryMap Map<String, String> map, Callback<CommonRespBean<SendWaterListBean>> cb);
//        @GET("/api/v1/communities/{communityId}/shops")


//       /api/v3/communities/{小区ID}/convenientPhones?page={页码}&limit={页面大小}
        @GET("/api/v3/communities/{communityId}/convenientPhones")
