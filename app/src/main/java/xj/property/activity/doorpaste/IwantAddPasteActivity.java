 ...
 * 发起Add门贴
 */
public class IwantAddPasteActivity extends HXBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iwant_addpaste);
    ...
    private void initView() {
        ...
        iwant_provider_title_et.setText(itemBean.getAddress());
        iwant_provider_title_et.setEnabled(false);
        ...
        if (isExample) {
            CountDownTimer countDownTimer = new CountDownTimer(2 * 1000, 1000) {
                ...
                public void onFinish() {
                    ...
                    ToastUtils.showToast(getmContext(), "示例贴成功");
                    doorPastedoShareDialog = new DoorPastedoShareDialog(IwantAddPasteActivity.this, new SocializeListeners.SnsPostListener() {
                        @Override
                        public void onStart() {
                        }
                        @Override
