 ...
 */
public class BalckListAdapter extends BaseAdapter {
    Context context;
    ...
    public BalckListAdapter(Context context, ArrayList<BlackUserInfo> list){
        if (list != null)
            this.list = list;
...
//                "xj.property"));
        ...
        vh.iv_detele.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BlackListViewActivity)context).refresh(position);
            }
        });
        return convertView;
    }
