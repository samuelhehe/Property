 ...
 */
public class BonusToPayAdapter extends BaseAdapter {
    Context context;
    ...
    public BonusToPayAdapter(Context context,  ArrayList<UserBonusBean> userBonusBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_bonus_topay, null);
        ...
        viewHolder.tv_bonus_price.setText("￥"+bean.getBonusPrice());
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        BonusToPayAdapter.isSelected = isSelected;
    }
}
