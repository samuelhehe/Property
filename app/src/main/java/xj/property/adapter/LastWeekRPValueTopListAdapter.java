 ...
 */
public class LastWeekRPValueTopListAdapter extends BaseAdapter {
   ...
   int colorBlack=0xff333333;
    ...
    public LastWeekRPValueTopListAdapter(Context context, ListView listView, List<RPTopListItem> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.lastweek_rpvalue_top_list_item, null);
...
//        viewHolder.txt_all_rpvalue.setText("("+bean.getCharacterValues()+")");
        ...
        viewHolder.txt_top_num.setText(""+(dataList.indexOf(bean)+1));
