 ...
 */
public class FitmentFinishSchemeAdapter extends BaseAdapter {
    ...
    public FitmentFinishSchemeAdapter(Context mContext,String url,List<FitmentFinishCompanyData> mlist){
