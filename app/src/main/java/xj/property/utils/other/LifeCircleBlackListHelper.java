...
import xj.property.beans.LifeCircleBlackRequest;
 ...
 */
public class LifeCircleBlackListHelper {
     ...
     * v3 2016/03/04
     */
    public static void addBlack(final Context context, final String emobIdTo, final Handler handler) {
