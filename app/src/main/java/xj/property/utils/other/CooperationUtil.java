...
//  }
     ...
     * @param emobIdTo 给谁评论
     * @param detailContent 评论内容
     * @param cooperationId 邻居帮ID
     * @param handler handler回调
     */
    public static void eva ( Context context,String emobIdFrom, String emobIdTo, String detailContent, int cooperationId,int communityId ,Handler handler) {
        addEva(context, handler, new CooperationEveReqBean(emobIdFrom,emobIdTo, detailContent, cooperationId,communityId));
    }
...
//        @POST("/api/v1/communities/{communityId}/cooperations/detail")
//        void addEva(@Header("signature") String signature, @Body CooperationEveReqBean lifeEvaBean, @Path("communityId") int communityId, Callback<CooperationEveRespBean> cb);
//        @POST("/api/v1/communities/{communityId}/cooperations/detail")

        @POST("/api/v3/cooperations/comment")
        void addEva(@Body CooperationEveReqBean lifeEvaBean, Callback<CommonRespBean<Integer>> cb);
    }

    public static void addEva( Context context, final Handler handler, CooperationEveReqBean lifeEvaBean) {
